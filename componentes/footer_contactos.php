            ...
            <div class="row caixafim">
                ...
                <nav class="col-12 navbar navbar-expand-lg f_menu">
                    ...
                    <div class="collapse  navbar-collapse justify-content-center" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link menu-rodape <?= ($pagina_atual == "home") ? "selected" : ""; ?>" aria-current="page" href="#menu-home">home</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row d-none d-md-block mb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 cookies">
                            ...
                            <div class="col-12 p">Copyright © 2021 Grupo MediaMaster. Todos os direitos reservados.</div>
                            </div>
                        </div>
                    </div>
                </div>
